...
def load_solution(data: str | dict):
    """
    Load an optimization solution from a JSON string or dict and return the satellite, provider, station, and contact
    dictionaries.

    Args:
        data (str | dict): JSON string or dictionary containing the optimization solution
